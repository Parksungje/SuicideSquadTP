Shader "Unlit/GeoGrass" {
    Properties {
        ...
        _WindStrength("Wind Strength", Range(0, 5)) = 0.1
        _TessellationUniform("Tessellation Uniform", Range(1, 500)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag (GeometryOutput input, bool isFrontFace : SV_IsFrontFace) : SV_Target {
                ...
                float modifiedShadowAttenuation = lerp(1.0, mainLight.shadowAttenuation, _ShadowStrength);
                
                float3 shading = NdotL * up * modifiedShadowAttenuation * mainLight.color + ambient;
